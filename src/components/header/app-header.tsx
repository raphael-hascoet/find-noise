...
export const AppHeader = () => {
  return (
    <header className="pointer-events-none fixed top-0 right-0 left-0 z-50 flex items-center justify-between p-4">
      <HomeVinyl />
      <SearchBar />
    </header>
  );
  ...
  return (
    <div className="pointer-events-auto relative flex items-center">
      <input
        type="text"
        placeholder="Search..."
        className="rounded-md border border-zinc-800 bg-black/80 py-1 pr-10 pl-3 text-zinc-300 focus-visible:outline-violet-600/25"
